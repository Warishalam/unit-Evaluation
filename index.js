var productData = [
  ...
  var filteredData = JSON.parse(JSON.stringify(productData));
    ...
    document.querySelector('#sort-by-price').addEventListener('change', function() {
      var sortType = document.querySelector('#sort-by-price').value;
      if(sortType === 'none') {
    ...
    document.querySelector('#sort-by-rating').addEventListener('change', function() {
      var sortType = document.querySelector('#sort-by-rating').value;
      if(sortType === 'none') {
        displayData(mensData);
      } else {
        filteredData.sort(function(a, b) {
